...
# Partitions (Dynamic)
BOARD_MTK_DYNAMIC_PARTITIONS_SIZE  := 9124708352
...
ifneq ($(WITH_GMS),true)
  ...
  BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE ?= 315621376
  BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE ?= 315621376
endif
